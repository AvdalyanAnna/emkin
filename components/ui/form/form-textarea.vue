<template lang="pug">
  .textarea(:class="Mods")
    ...
    textarea.textarea__field.textarea__field_shadow(:maxlength="max"   @keydown.enter.exact.prevent="$emit('enter')" @input="$emit('input',$event.target.value)" v-model="currentValue" ref="shadow" tabindex="0")
