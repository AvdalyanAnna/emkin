<template lang="pug">
	form.chat-search(action="/")
		form-input.chat-search__input(:placeholder="placeholder" v-model="search" name="search" :value="value" @input="searchQuery")
		button.chat-search__btn
			svg-icon(name="search")
		button.chat-search__clear(v-if="search && search.length > 0" type="button" @click="clearSearch")
