<template lang="pug">
  .item-notification(:class="Mods" @click.prevent="$emit('actions')")
    .item-notification__row
      .item-notification__column.item-notification__column_left.flex
        ...
        .item-notification__cell.item-notification__cell_right(@click.stop="")
          module-date.item-notification__date.hidden {{ format(new Date(date), 'dd.MM.yyyy') }}
          .item-notification__desc.content.text-wrap(v-html="descMin" ref="desc"  :class="Class")
      ...
      .item-notification__column.item-notification__column_right
        .item-notification__top.flex.flex_right.flex_start
          module-date.item-notification__date {{ format(new Date(date), 'dd.MM.yyyy') }}
        .item-notification__bottom.flex.flex_right(@click.stop="")
          button-medium.item-notification__btn(gray @click.native.prevent="$emit('delete')" ) {{content.delete}}
          span.item-notification__btn.button-medium_blue.button-medium(  @click.prevent="openLink(link)"  v-if="link !== '' && btn !== ''")
