<template lang="pug">
  b-modal(
    ...
    transition(v-if="DETAIL")
      .modal-card__row.flex.flex_justify
        .modal-card__column.modal-card__column_left
          part-single-gallery.modal-card__gallery(v-if="DETAIL" :TestImages="$galleryListNew(DETAIL.gallery,DETAIL.link)")
    ...
    .mobile-card__footer
      ...
      button-primary.mobile-card__footer-button(@click.native='closeModal') {{PAGE_PRODUCT_DERAILS.close}}
    transition(v-if="!DETAIL")
      .loading-block
        loader.white.big
