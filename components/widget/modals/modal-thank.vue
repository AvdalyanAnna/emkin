<template lang="pug">
  b-modal(
    ...
    .modal-thank__desc.color-gray.h4 {{desc || POPUP_THANK.desc}}
    button-primary.modal-thank__btn(v-if="!notRedirectToHome" to="/" blue) {{POPUP_THANK.btn}}
    button-primary.modal-thank__btn(v-if="notRedirectToHome" @click.native.prevent="hideModal()" blue) {{'Close'}}
</template>
