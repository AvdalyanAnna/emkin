  ...
  b-modal(
    ...
    form(  ref="send-form" )
      ...
      .form-contact__fields
        ...
        .form-contact__field
          .form-contact__label.h4 Select the type of complaint
          form-select-refusal.form-contact__select(@input="(val) => refusal = val" v-model="refusal" :items="refusals"  default)
        .form-contact__field
          .form-contact__label.h4 Your comment
          form-input.form-contact__input(
            :placeholder="'Your comment'" name="description" textarea v-model="form.description"
