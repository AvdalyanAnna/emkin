<template lang="pug">
  section.section-annoucements
    part-analytics-box.section-annoucements__analytics(:key="pageKey" :slides="slides")
    part-annoucements.section-annoucements__section(:content="PAGE_MY_ADVERTISES")
    modal-statistic
...
export default {
  ...
  computed: {
    ...
    slides() {
      ...
      if (this.$screen.lt) slider.push(...this.USER_BANNERS)
      return slider
    }
  },
  async created() {
