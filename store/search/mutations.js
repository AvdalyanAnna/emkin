...
import {updateAnswerIds, removeAnswerIds, addAnswersToGlobalArray} from '@/mixins/helpers/search'
...
export default {
  ...
  ADD_SEARCH_ANSWERS_IDS(state, obj) {
    ...
    state.answersFiltersIds = updateAnswerIds(answersFiltersIds, value.id, index);
    state.answersIds = addAnswersToGlobalArray(state.answersFiltersIds, [])
  },
  REMOVE_SEARCH_ANSWERS_IDS(state, obj) {
    ...
    let answersFiltersIds = cloneDeep(state.answersFiltersIds || [])
    state.answersFiltersIds = removeAnswerIds(answersFiltersIds, value.id, index);
    state.answersIds = addAnswersToGlobalArray(state.answersFiltersIds, [])
  },
  ...
  CHANGE_GLOBAL_SEARCH_ANSWERS(state) {
    state.search.answersFiltersIds = state.answersFiltersIds
  },
